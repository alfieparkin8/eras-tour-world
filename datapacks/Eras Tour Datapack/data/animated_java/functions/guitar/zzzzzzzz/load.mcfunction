...
scoreboard players set $aj.guitar.variant.fearless aj.id 2
scoreboard players set $aj.guitar.variant.lavender aj.id 3
scoreboard players set $aj.guitar.variant.surprise aj.id 4
scoreboard players add .aj.last_id aj.id 0
scoreboard players set $aj.loop_mode.loop aj.i 0
scoreboard players set $aj.loop_mode.once aj.i 1
scoreboard players set $aj.loop_mode.hold aj.i 2
scoreboard players set aj.guitar.export_version aj.i -176032559
