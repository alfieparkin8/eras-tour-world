...
scoreboard players set $aj.lover_microphone.variant.sunset_lover aj.id 6
scoreboard players set $aj.lover_microphone.variant.violet_lover aj.id 7
scoreboard players add .aj.last_id aj.id 0
scoreboard players set $aj.loop_mode.loop aj.i 0
scoreboard players set $aj.loop_mode.once aj.i 1
scoreboard players set $aj.loop_mode.hold aj.i 2
scoreboard players set aj.lover_microphone.export_version aj.i 216098204
