...
execute if score @s aj.lover_microphone.animation.rolling.local_anim_time matches 79.. run function animated_java:lover_microphone/zzzzzzzz/animations/rolling/end