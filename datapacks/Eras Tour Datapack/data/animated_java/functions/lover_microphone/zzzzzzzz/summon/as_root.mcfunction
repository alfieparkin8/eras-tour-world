...
execute if score #variant aj.i = $aj.lover_microphone.variant.tangerine_lover aj.id run function animated_java:lover_microphone/zzzzzzzz/apply_variant/tangerine_lover/as_root
