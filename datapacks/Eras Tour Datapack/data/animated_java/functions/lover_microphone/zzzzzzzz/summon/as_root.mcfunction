...
execute if score #variant aj.i = $aj.lover_microphone.variant.golden aj.id run function animated_java:lover_microphone/zzzzzzzz/apply_variant/golden/as_root
execute if score #variant aj.i = $aj.lover_microphone.variant.heart aj.id run function animated_java:lover_microphone/zzzzzzzz/apply_variant/heart/as_root
...
execute if score #variant aj.i = $aj.lover_microphone.variant.sunset aj.id run function animated_java:lover_microphone/zzzzzzzz/apply_variant/sunset/as_root
execute if score #variant aj.i = $aj.lover_microphone.variant.violet aj.id run function animated_java:lover_microphone/zzzzzzzz/apply_variant/violet/as_root
...
execute if score #animation aj.i = $aj.lover_microphone.animation.hips aj.id run function animated_java:lover_microphone/zzzzzzzz/animations/hips/apply_frame_as_root
execute if score #animation aj.i = $aj.lover_microphone.animation.hips aj.id run scoreboard players operation @s aj.lover_microphone.animation.hips.local_anim_time = #frame aj.i
