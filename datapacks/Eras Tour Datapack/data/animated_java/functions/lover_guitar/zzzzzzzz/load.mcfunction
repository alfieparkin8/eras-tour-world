...
scoreboard players set $aj.lover_guitar.variant.sun_rise aj.id 5
scoreboard players set $aj.lover_guitar.variant.sun_rise_blue aj.id 6
scoreboard players set $aj.lover_guitar.variant.sunset_blue aj.id 7
scoreboard players set $aj.lover_guitar.variant.violet aj.id 8
scoreboard players set $aj.lover_guitar.variant.violet_blue aj.id 9
scoreboard players add .aj.last_id aj.id 0
scoreboard players set $aj.loop_mode.loop aj.i 0
scoreboard players set $aj.loop_mode.once aj.i 1
scoreboard players set $aj.loop_mode.hold aj.i 2
scoreboard players set aj.lover_guitar.export_version aj.i 809676899
