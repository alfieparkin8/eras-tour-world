...
scoreboard objectives add aj.microphone.animation.rolling.local_anim_time dummy
...
scoreboard objectives add aj.microphone.animation.rolling.loop_mode dummy
...
scoreboard players set $aj.microphone.animation.rolling aj.id 4
scoreboard players set $aj.microphone.variant.default aj.id 0
scoreboard players add .aj.last_id aj.id 0
scoreboard players set $aj.loop_mode.loop aj.i 0
scoreboard players set $aj.loop_mode.once aj.i 1
scoreboard players set $aj.loop_mode.hold aj.i 2
scoreboard players set aj.microphone.export_version aj.i 936806745
