...
execute if score @s aj.folklore_microphone.animation.kneel.local_anim_time matches 60.. run function animated_java:folklore_microphone/zzzzzzzz/animations/kneel/end